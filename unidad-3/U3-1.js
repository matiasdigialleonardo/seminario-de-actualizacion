class CustomCalculator extends HTMLElement
{
	constructor()
	{
		...
		this.btn2.innerText = '2'; //<button>2</button>
		this.btn3.innerText = '3'; //<button>3</button>
		this.btn4.innerText = '4'; //<button>4</button>
		this.btn5.innerText = '5'; //<button>5</button>
		this.btn6.innerText = '6'; //<button>6</button>
		this.btn7.innerText = '7'; //<button>7</button>
		this.btn8.innerText = '8'; //<button>8</button>
		this.btn9.innerText = '9'; //<button>9</button>
		this.btnDot.innerText = '.'; //<button>9</button>

		this.btnPlus.innerText = '+'; //<button>+</button>
		this.btnMinus.innerText = '-'; //<button>-</button>
		this.btnMultiply.innerText = '*'; //<button>*</button>
		this.btnDivision.innerText = '/'; //<button>/</button>
